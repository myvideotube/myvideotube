...
const Teste = () => {
  return(
    <Swiper autoplay={true}>
      <div><img className="d-block w-100" src={films} alt="First slide"/></div>
      <div><img className="d-block w-100" src={tec}
             alt="Second slide"/></div>
      <div><img className="d-block w-100" src={mus}
           alt="Third slide"/></div>
      <div><img className="d-block w-100" src={animais}
             alt="Fourth slide"/></div>
      <div><img className="d-block w-100" src={gaming}
             alt="Five slide"/></div>
     <div><img className="d-block w-100" src={sports}
                    alt="Six slide"/></div>
     <div><img className="d-block w-100" src={news}
                           alt="Seven slide"/></div>
     <div><img className="d-block w-100" src={education}
                                  alt="Eight slide"/></div>
    </Swiper>
  )
}
