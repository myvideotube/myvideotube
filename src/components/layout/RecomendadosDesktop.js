            ...
            <div>
                ...
                <div className="ml-2 mr-2 display-desktop" style={{marginTop: -158 + "px", zIndex: 1200}}>
                    <div className="mt-3" style={{marginLeft: "1rem"}}>
                        <h4 style={{color: "white", fontFamily: "tipodez"}}>Trending</h4>
                        <hr style={{
                                    ...
                                    {(() => {
                                        ...
                                        if (this.state.id == i) {
                                            if (!this.props.auth.uid) {
                                                return (
                                                    <div
                                                        className={"gallery-cell posicao " + this.state.hover + " " + this.state.destaque}
                                                        onMouseOver={this.handleOnHover} onMouseOut={this.handleOnOut}
                                                        id={i} key={i}>
                                                        <div className="video_window fade_cartoes_carrossel">
                                                            ...
                                                            <div className="caption fade-caption" style={{
                                                                display: this.state.displayFade,
                                                                marginTop: "-178px",
                                                                width: "100%",
                                                                height: "100%",
                                                                padding: "4px 2px",
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="video_window fade_cartoes_carrossel">
                                                            ...
                                                            <div className="caption fade-caption" style={{
                                                                ...
                                                                <div id={i} title={item.title}
                                                                     description={item.description}
                                                                     dailyID={item.dailyID} vimeoID={item.vimeoID}
                                                                     onClick={this.toggleModal}
                                                                     youtubeID={item.youtubeID} className="text-center">
                                                                    <PlayButton rec={this.state.rec}
                                                                                idrec={this.state.idlike} item={item}
                                                                                addRec={this.addRec} id={item.id}
                                                                                title={item.title}
                                                                                description={item.description}
                                                                                img={item.img} link={item.link}/>
                                                                </div>
                                                                {/*--- DIV QUE ENGLOBA OS COMANDOS RÁPIDOS DO VÍDEO (ex. like) */}
                                                                <div className="text-right ml-3 mb-2"
                                                                     style={{width: 270 + "px", paddingTop: 25 + "px"}}>

                                                                    {/*--- BOTÃO DE LIKE */}
                                                                    <LikeVideo click={this.state.click}
                                                                               idlike={this.state.idlike} item={item}
                                            ...
                                            return (
                                                <div className={"gallery-cell posicao " + this.state.hover}
                                                     onMouseOver={this.handleOnHover} id={i} key={i}>
