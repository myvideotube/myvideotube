...
const dailyURL = 'https://api.dailymotion.com/videos?channel=lifestyle&fields=id,thumbnail_360_url,title,embed_url,description,duration&thumbnail_ratio=widescreen&language=eng';
const vimeoURL = 'https://api.vimeo.com/categories/fashion/videos?per_page=10&access_token=d2f6be440960fe41b9766ffafcbe6bdd';
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    <Carousel autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={false} showStatus={false} showThumbs={false}	transitionTime={350} interval={3000} style={{position: "relative", marginTop: -50 + "px",}} >
                                                    <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                                        <img className="d-block w-100 h-100 mt-0" src={this.props.carrosel[19].beauty1.beauty1} alt="First slide" style={{width: "100%"}}/>
                                                    </div>
                                                    <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                                        <img className="d-block w-100 h-100"src={this.props.carrosel[19].beauty2.beauty2} alt="Second slide" style={{width: "100%"}}/>

                                                    </div>
                                                    <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                                        <img className="d-block w-100 h-100" src={this.props.carrosel[19].beauty3.beauty3} alt="Third slide" style={{width: "100%"}}/>
                                                    </div>
                                                </Carousel>
                    </div>
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white', fontFamily: "tipodez"}}> Beauty & Fashion </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative", fontFamily: "tipodez"}}>Beauty & Fashion</h4>
                                            <hr style={{
