...
const finalURL = `https://www.googleapis.com/youtube/v3/videos?part=contentDetails%2Csnippet&chart=mostPopular&videoCategoryId=26&key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8&maxResults=3`
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    <Carousel autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={false} showStatus={false} showThumbs={false}	transitionTime={350} interval={3000} style={{position: "relative", top: "-50px"}} >
                        <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                            <img className="d-block w-100 h-100 mt-0" src={this.props.carrosel[3].lifestyle1.lifestyle1} alt="First slide" style={{width: "100%"}}/>
                        </div>
                        <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                            <img className="d-block w-100 h-100" src={this.props.carrosel[3].lifestyle2.lifestyle2} alt="Second slide" style={{width: "100%"}}/>
                        </div>
                        <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                            <img className="d-block w-100 h-100" src={this.props.carrosel[3].lifestyle3.lifestyle3} alt="Third slide" style={{width: "100%"}}/>
                        </div>
                    </Carousel>
                    </div>
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white', fontFamily: "tipodez"}}> Lifestyle </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative"}}>Lifestyle</h4>
                                            <hr style={{
