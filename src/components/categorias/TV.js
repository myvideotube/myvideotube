...
const vimeoURL = 'https://api.vimeo.com/categories/videojournalism/videos?per_page=10&access_token=d2f6be440960fe41b9766ffafcbe6bdd';
const dailyURL = 'https://api.dailymotion.com/videos?channel=tv&fields=id,thumbnail_360_url,embed_url,title,description,duration&thumbnail_ratio=widescreen&language=eng';
const finalURL = `https://www.googleapis.com/youtube/v3/activities?part=contentDetails%2C%20snippet&channelId=UCGie8GMlUo3kBKIopdvumVQ&order=date&maxResults=3&key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8`;
const array_geral = [];
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    <Carousel autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={false} showStatus={false} showThumbs={false}	transitionTime={350} interval={3000} style={{position: "relative", marginTop: -50 + "px",}} >
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100 mt-0" src={this.props.carrosel[11].tv1.tv1} alt="First slide" style={{width: "100%"}}/>
                                </div>
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100"src={this.props.carrosel[11].tv2.tv2} alt="Second slide" style={{width: "100%"}}/>

                                </div>
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100" src={this.props.carrosel[11].tv3.tv3} alt="Third slide" style={{width: "100%"}}/>
                                </div>
                            </Carousel>
                    </div>
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white', fontFamily: "tipodez"}}> TV </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative", fontFamily: "tipodez"}}>TV</h4>
                                            <hr style={{
