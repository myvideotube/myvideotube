...
const finalURL = `https://www.googleapis.com/youtube/v3/videos?part=contentDetails%2Csnippet&chart=mostPopular&videoCategoryId=28&key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8&maxResults=3`
const dailyURL = 'https://api.dailymotion.com/videos?channel=tech&fields=id,thumbnail_360_url,title,embed_url,description,duration&thumbnail_ratio=widescreen&language=eng';
const vimeoURL = 'https://api.vimeo.com/categories/tech/videos?per_page=10&access_token=d2f6be440960fe41b9766ffafcbe6bdd';
                            ...
                            .then((resp) => {
                                ...
                                for (let i in this.state.vimeovideo) {
                                    array_geral.push({
                                        ...
                                        "vimeoID": this.state.vimeovideo[i].uri.substr(8),
                                ...
                                for (let i in this.state.ytvideo) {
                                    array_geral.push({
                                        ...
                                        "description": this.state.ytvideo[i].snippet.description,
                                        "img": this.state.ytvideo[i].snippet.thumbnails.medium.url,
                                        "link": "https://www.youtube.com/embed/" + this.state.ytvideo[i].id,
                                        "youtubeID": this.state.ytvideo[i].id,
                                        "duration": this.state.ytvideo[i].contentDetails.duration
                                    });
                                }
        ...
        return (
            <div>
                ...
                <div className="display-desktop"
                     style={{width: '100%', zIndex: 1, height: '400px', top: -37 + "px", position: 'absolute'}}>
                    <div style={{
                        width: '100%',
                        zIndex: 2,
                    ...
                    <div className="d-flex toggled" id="wrapper">
                        ...
                        <div id="wrap" className style={{width: '100%', margin: 0}}>
                            ...
                            <div style={{marginTop: -50 + "px"}}>
                                <Carousel autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={false}
                                          showStatus={false} showThumbs={false} transitionTime={350} interval={3000}
                                          style={{position: "relative", marginTop: -50 + "px",}}>
                                    <div style={{height: 400 + "px", marginTop: -50 + "px"}}>
                                        <img className="d-block w-100 h-100 mt-0"
                                             src={this.props.carrosel[1].tech1.tech1} alt="First slide"
                                             style={{width: "100%"}}/>
                                    </div>
                                    <div style={{height: 400 + "px", marginTop: -50 + "px"}}>
                                        <img className="d-block w-100 h-100" src={this.props.carrosel[1].tech2.tech2}
                                             alt="Second slide" style={{width: "100%"}}/>

                                    </div>
                                    <div style={{height: 400 + "px", marginTop: -50 + "px"}}>
                                        <img className="d-block w-100 h-100" src={this.props.carrosel[1].tech3.tech3}
                            ...
                            <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px", zIndex: 2}}>
                                <h4 className="mt-5 ml-2"
                                    style={{color: 'white', fontFamily: "tipodez"}}> Technology </h4>
                                <hr className="ml-2" style={{
                                    background: 'linear-gradient(90deg, #801336, transparent)',
                                    height: '1px',
                                    border: 0
                                }}/>
                                        ...
                                        return (
                                            <div class="row mt-5 square" id="content"
                                                ...
                                                {this.state.array_videos.map((item, i) => {
                                                    ...
                                                    if (!this.props.auth.uid) {
                                                        return (
                                                            <div class="card largura quickview aumento fade_cartoes"
                                                                 onMouseOver={this.onMouseOver} key={i} id={item.id}>
                                                                <div class="card_categoria">
                                                                    <img class="card-img-top cartao " src={item.img}/>
                                                                    <span className="caption fade-caption">
                                                <div className="text-center">
                                                <button style={{backgroundColor: "transparent", color: "white"}} id={i}
                                                        title={item.title} description={item.description}
                                                        dailyID={item.dailyID} vimeoID={item.vimeoID}
                                                        onClick={this.toggleModal} youtubeID={item.youtubeID}>
                                              ...
                                              {/*--- BOTÃO DE LIKE */}
                                                                            ...
                                                                            <button style={{
                                                                                ...
                                                                                color: "white"
                                                                            }} click={this.state.click} item={item}
                                                                                    addLike={this.addLike} id={item.id}
                                                                                    title={item.title}
                                                                                    description={item.description}
                                                                                    img={item.img}
                ...
                <div className="display-mobile">
                    <div>
                        <div className="display-mobile"
                             style={{width: '100%', zIndex: 1, height: '261px', top: -37 + "px", position: 'absolute'}}>
                            <div style={{
                                width: '100%',
                                zIndex: 2,
                                background: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.2) 100%)',
                        ...
                        <Carousel className="carrossel_mobile_cat" autoPlay={true} showArrows={false}
                                  infiniteLoop={true} showIndicators={false} showStatus={false} showThumbs={false}
                                  transitionTime={350} interval={3000}
                                  style={{position: "relative", top: '73px', marginTop: -50 + "px",}}>
                            <div style={{height: 200 + "px", marginTop: -50 + "px"}}>
                                <img className="d-block w-100 h-100 mt-0" src={this.props.carrosel[1].tech1.tech1}
                        ...
                        <div id="page-content-wrapper" className=" display-mobile"
                            ...
                            <div className="mt-3" style={{marginLeft: "1rem"}}>
                                <h4 style={{color: "white", zIndex: 80, position: "relative"}}>Technology</h4>
                                <hr style={{
                                ...
                                <div className="row square ">
                                    {this.state.array_videos.map((item, i) => {
                                        ...
                                        return (
                                            ...
                                            <div className="card largura quickview pagina-cat" id={i}
                                                 style={{margin: 'auto'}}>
                                                {(() => {
                                                    if (!this.props.auth.uid) {
                                                        return (
                                                            <div className="altura">
                                                                <div className="card_categoria" id={i}
                                                                    ...
                                                                    <img className="card-img-top cartao "
                                                                         src={item.img}/>
                                                                </div>
                                                                <div className="row">
                                                                ...
                                                                <div className="altura">
                                                                    ...
                                                                    <div className="row">
                                                                        ...
                                                                        <i style={{
                                                                           ...
                                                                           onClick={this.displayButtons} id={i}></i>
                                                                    </div>
                                                                    <div className="botoes-mobile"
                ...
                <ModalVideo show={this.state.isOpen} onClose={this.toggleModal} link={array_geral} id={this.state.id}
                            vimeoID={this.state.vimeoID} dailyID={this.state.dailyID} youtubeID={this.state.youtubeID}
