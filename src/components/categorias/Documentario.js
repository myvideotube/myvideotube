...
const dailyURL = 'https://api.dailymotion.com/videos?channel=shortfilms&fields=id,thumbnail_360_url,embed_url,title,description,duration&thumbnail_ratio=widescreen&language=eng';
const vimeoURL = 'https://api.vimeo.com/categories/documentary/videos?per_page=10&access_token=d2f6be440960fe41b9766ffafcbe6bdd';

const finalURL = `https://www.googleapis.com/youtube/v3/search?key=AIzaSyDhsERNhsX0wnS3dW-Vc9eMykFvrLKeqQ8&channelId=UCt84aUC9OG6di8kSdKzEHTQ&part=contentDetails%2Csnippet&order=date&maxResults=3`
const array_geral = [];
class Documentario extends Component {
              ...
              fetch(vimeoURL)
               ...
               .then((resp) => {
                 ...
                 for(let i in this.state.ytvideo) {
                      array_geral.push({"id": this.state.ytvideo[i].contentDetails.upload.videoId, "title": this.state.ytvideo[i].snippet.title, "description": this.state.ytvideo[i].snippet.description, "img": this.state.ytvideo[i].snippet.thumbnails.medium.url, "link": "https://www.youtube.com/embed/" + this.state.ytvideo[i].contentDetails.upload.videoId, "youtubeID": this.state.ytvideo[i].contentDetails.upload.videoId,"duration": this.state.ytvideo[i].contentDetails.duration});
                 }

                 for (let i in this.state.dailyvideo) {

                   array_geral.push({"id": this.state.dailyvideo[i].id, "title": this.state.dailyvideo[i].title, "description": this.state.dailyvideo[i].description, "img": this.state.dailyvideo[i].thumbnail_360_url, "link": this.state.dailyvideo[i].embed_url, "dailyID": this.state.dailyvideo[i].id, "duration": this.state.vimeovideo[i].duration});
                ...
                {/*------------FIM DO MOBILE-------------*/}
                    ...
                    <Carousel autoPlay={true} showArrows={false} infiniteLoop={true} showIndicators={false} showStatus={false} showThumbs={false}	transitionTime={350} interval={3000} style={{position: "relative", marginTop: -50 + "px",}} >
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100 mt-0" src={this.props.carrosel[18].documentary1.documentary1} alt="First slide" style={{width: "100%"}}/>
                                </div>
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100"src={this.props.carrosel[18].documentary2.documentary2} alt="Second slide" style={{width: "100%"}}/>

                                </div>
                                <div style={{ height: 400 + "px", marginTop: -50 + "px"}}>
                                    <img className="d-block w-100 h-100" src={this.props.carrosel[18].documentary3.documentary3} alt="Third slide" style={{width: "100%"}}/>
                                </div>
                            </Carousel>
                    </div>
                    {/* --------------- // CARROSSEL DAS IMAGENS ---------------- */}
                        ...
                        <div className="col-lg-12 display-desktop" style={{marginTop: -120 + "px",  zIndex: 2}}>
                            <h4 className="mt-5 ml-2" style={{color: 'white', fontFamily: "tipodez"}}> Documentary </h4>
                                ...
                                <div>
                                    ...
                                    <div id="page-content-wrapper" className=" display-mobile" style={{position: "relative", top: "44px"}}>
                                        ...
                                        <div className="mt-3" style={{marginLeft: "1rem"}}>
                                            <h4 style={{color: "white", zIndex:80, position: "relative", fontFamily: "tipodez"}}>Documentary</h4>
                                            <hr style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(Documentario)
